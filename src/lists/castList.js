export const castList = {
  Court: [
    "The royalty and noblity at the faire grounds. They perform they're noble duties whilst running amok in the crowds.",
    {
      ...
      image: "src/images/cast/joseph-fieger-sr.jpg",
    },
    {
    ...
    },
    {
      ...
      image: "src/images/cast/lanya-da-silva.jpg",
    }, //Continued positions: Holy Roman Empress, Empress of the Universe, Queen of England, Spain and EVERYTHING, Duchess of Milan
    {
      ...
      image: "src/images/cast/trenton-brookesher.jpg",
    },
    {
      realName: "Jacqueline Brown",
      role: "Princess Mary",
      position: "Crown Princess of England",
      image: "src/images/cast/jacqueline-brown.jpg",
    },
    {
      realName: "Kat Whalen",
      ...
      image: "src/images/cast/kathleen-whalen.jpg",
    ...
    },
    {
      ...
      position: '',
      image: 'src/images/cast/brendan-noe.jpg'
    },
    {
      realName: "Jason Smallen",
      role: "Sir William Carey",
      position: "",
      image: "src/images/cast/jason-smallen.jpg",
    },
    {
      realName: "Sheana Godwin",
      role: "",
      position: "Duchess",
      image: "src/images/cast/sheana-godwin.jpg",
    },
    {
      realName: "Kristen Haynes",
      role: "Anne Boleyn",
      position: "Lady in Waiting",
      image: "src/images/cast/kristen-haynes.jpg",
    },
    {
      realName: "Amber Fern",
      role: "Jane Seymour",
      position: "Lady in Waiting",
      image: "src/images/cast/amber-fern.jpg",
    },
    {
      realName: "Zak Gilliland",
      role: "Richard",
      position: "Noble Assistant",
      image: "src/images/cast/zak-gilliland.jpg",
    },

    {
      ...
      role: "Harold",
      position: "Herald",
      image: "src/images/cast/chris-siebert.jpg",
    },
    {
      realName: "Kathryn Smallen",
      role: "",
      position: "English Royal Guard",
      image: "src/images/cast/kathryn-smallen.jpg",
    },
    {
      realName: "James Boswell",
      role: "",
      position: "French Royal Guard",
      image: "src/images/cast/james-boswell.jpg",
    },
  ],
  Fae: [
  ...
  Fighter: [
    "The fighters are the ones who intent to put on a show in the lanes with some form of weaponry.",
    {
      ...
      image: "src/images/cast/dan-blinn-placeholder.jpg",
    ...
    },
    {
      ...
      position: "Kingsman",
      image: "src/images/cast/noel-kling.jpg",
    },
  ],
  Traveler: [
    "The traders, craftmaen, entertainers, and their own brand of royalty as they're their own traveling village.",
    {
      ...
      image: "src/images/cast/david-hernandez.jpg",
    },
    {
      realName: "Susanna Ennenbach",
      role: "Sasha",
      position: "Herbalist",
      image: "src/images/cast/susanna-ennenbach.jpg",
    },
    {
      realName: "Catherine Kuehner",
      role: "Volyana",
      position: "Entertainer",
      image: "src/images/cast/catherine-kuehner.jpg",
    },
    {
      realName: "Grace Mays",
      role: "Katerina",
      position: "",
      image: "src/images/cast/grace-mays.jpg",
    },
    {
      realName: "Krista Strahm",
      role: "Zelma",
      position: "Matriarch",
      image: "src/images/cast/krista-strahm.jpg",
