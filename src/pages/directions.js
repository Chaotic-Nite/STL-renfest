  ...
  return (
    <>
      ...
      <div style={{ marginLeft: "10vw", marginTop: "2%" }}>
        <h3>
          If image isn't loading or prefer an offline copy. <br /> Download the
          current map{" "}
          <DownloadLink
            label="Here"
            filename="STLFaireMap.jpg"
    ...
    <>
      ...
      <div style={{ marginLeft: "10vw", marginTop: "2%" }}>
        ...
        <ol className="direct-list">
          <li>
            Take I-70 West from STL (or Hwy 4 to I-70W) toward Wentzville to 61
            North.
          </li>
