  ...
  return <>
    ...
    <div className='margin-width two-col'>
      <div>
        ...
        <p style={{textAlign: 'left'}}><img src='/assets/images/mug.jpg' alt='Mug' style={{float:'left', width: '30rem', margin: '1.5%'}}/> Mid-America Festivals is the nation’s largest producer of outdoor themed events. In 2019, we entertained nearly one million people in a wide variety of locations across the country. <br /><br />
